...
export function CommandMenu({
  ...
  return <>
         <Button variant="outline" className={cn('relative w-full justify-start text-sm font-light text-muted-foreground sm:pr-12 md:w-40 lg:w-64')} onClick={() => setOpen(true)} {...props}>
         ...
         <CommandDialog open={open} onOpenChange={setOpen}>
            ...
            <CommandList>
               ...
               <CommandGroup heading="Links">
                  {docsConfig.sidebarNav.map(navItem => <CommandItem key={navItem.href} value={navItem.title} onSelect={() => {
