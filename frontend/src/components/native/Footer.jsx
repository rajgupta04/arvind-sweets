...
function Links() {
  return <div className="text-end justify-evenly grid grid-cols-2 gap-8 sm:grid-cols-3 sm:gap-6">
         {data.map(({
      label,
      links
    }) => <div key={label}>
          ...
          url
                        ...
                        <Link to={url} className="text-sm transition duration-300 text-muted-foreground hover:text-foreground">
                           {label}
                        </Link>
                     </li>)}
               </ul>
...
function Trademark() {
  return <div className="mb-6 hidden md:mb-0 md:block">
...
function Socials() {
  return <div className="mb-6 flex justify-center space-x-6 text-muted-foreground">
