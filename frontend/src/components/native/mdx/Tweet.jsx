...
export default function Tweet({
  ...
  return <div className="tweet my-4 w-full rounded-lg border border-neutral-200 bg-white px-6 py-4 dark:border-neutral-800 dark:bg-neutral-900">
         ...
         <div className="mt-2 flex text-sm !text-neutral-700 dark:!text-neutral-300">
            <a className="mr-4 flex items-center !text-neutral-500 transition hover:!text-blue-600 hover:!underline" href={replyUrl} target="_blank" rel="noreferrer">
            ...
            <a className="mr-4 flex items-center !text-neutral-500 transition hover:!text-green-600 hover:!underline" href={retweetUrl} target="_blank" rel="noreferrer">
               <svg className="mr-2" width="18" height="18" viewBox="0 0 24 24">
            ...
            <a className="flex items-center !text-neutral-500 transition hover:!text-red-600 hover:!underline" href={likeUrl} target="_blank" rel="noreferrer">
               <svg className="mr-2" width="18" height="18" viewBox="0 0 24 24">
